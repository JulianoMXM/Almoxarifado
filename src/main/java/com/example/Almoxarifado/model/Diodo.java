...
public class Diodo extends Componente{
    @NotNull(message = "A tensao reversa máxima é obrigatória.")
    ...
    @NotNull(message = "A corrente direta máxima é obrigatória.")
    ...
    @NotNull(message = "A queda de tensão é obrigatória.")
